...
public class ExpensesFront {
    ...
    public static Pane getStartFront(int fl) throws FileNotFoundException, SQLException, ParseException {
        ...
        FileInputStream Url;
        if(fl==1){
            Url = new FileInputStream("png/expensesDay.png");
        }
        else if(fl==2){
            Url = new FileInputStream("png/expensesWeek.png");
        }
        else if(fl==3){
            Url = new FileInputStream("png/expensesMonth.png");
        }
        else if(fl==4){
            Url = new FileInputStream("png/expensesYear.png");
        }
        else
            Url = new FileInputStream("png/expensesTime.png");
        ...
        String result = SQLite.getResExpenses(fl);
        text.setText(result);
        ...
        week.setOnAction(t1 ->{
            Front.root.getChildren().remove(Front.pane);
            try {
                Front.pane = ExpensesFront.getStartFront(2);
        ...
        day.setOnAction(t1 ->{
            Front.root.getChildren().remove(Front.pane);
            try {
                Front.pane = ExpensesFront.getStartFront(1);
            } catch (FileNotFoundException e) {
                throw new RuntimeException(e);
            } catch (SQLException e) {
                throw new RuntimeException(e);
        ...
        year.setOnAction(t1 ->{
            Front.root.getChildren().remove(Front.pane);
            try {
                Front.pane = ExpensesFront.getStartFront(4);
            } catch (FileNotFoundException e) {
                throw new RuntimeException(e);
            } catch (SQLException e) {
                throw new RuntimeException(e);
        ...
        detail.setOnAction(t1 ->{
            Front.root.getChildren().remove(Front.pane);
            try {
                Front.pane = DetailExpensesFront.getStartFront(fl);
            } catch (FileNotFoundException e) {
                throw new RuntimeException(e);
