...
public class Expenses {
    ...
    static String[] choise = {"Здоровье","Досуг","Дом","Кафе","Образование","Подарки","Продукты","Семья","Спорт",
            "Транспорт","Другое"};

    public Expenses(String id, String desc, String type, String summ, String date) {
        this.id = id;
        this.desc = desc;
        this.type = type;
        this.summ = summ;
    ...
    public static void addExpenses() throws FileNotFoundException {
        Group root_add = new Group();
        Scene scene_add = new Scene(root_add, 418, 318);
        Stage newWindow = new Stage();
        newWindow.initStyle(StageStyle.DECORATED);
        FileInputStream Url= new FileInputStream("png/addExpenses.png");
        ...
        comboBoxType.setValue("Продукты ");
        ...
        save.setOnAction(t1 ->{
            ...
            if(!q2.isEmpty()&&check2(q2)&&check(q4)) {
                try {
                    SQLite.addExpenses(q1,q2,q3,q4);
        ...
        newWindow.setTitle("Добавление расхода");
        newWindow.setScene(scene_add);
        newWindow.show();
    }

    public static void editExpenses(String id, ScrollPane scrollPane, int fl) throws FileNotFoundException, SQLException {
        Group root_add = new Group();
        Scene scene_add = new Scene(root_add, 418, 318);
        Stage newWindow = new Stage();
        Expenses expenses = SQLite.getExpenses_byID(id);
        newWindow.initStyle(StageStyle.DECORATED);
        FileInputStream Url= new FileInputStream("png/editExpenses.png");
        Image url = new Image(Url);
        ImageView front = new ImageView(url);
        front.setX(0);
        front.setY(0);
        ...
        save.setOnAction(t1 ->{
            ...
            if(!q2.isEmpty()&&check2(q2)&&check(q4)) {
                try {
                    SQLite.UpdateExpenses(id,q1,q2,q3,q4);
                    Pane pane = SQLite.getExpenses(fl,scrollPane);
        ...
        newWindow.setTitle("Редактирование расхода");
        newWindow.setScene(scene_add);
        newWindow.show();
    }
